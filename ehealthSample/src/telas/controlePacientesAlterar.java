...
public class controlePacientesAlterar extends javax.swing.JFrame {

    /**
     * Creates new form controlePacientes
     */
    public controlePacientesAlterar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtPlanoSaude.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtPlanoSaudeFocusGained(evt);
            }
        });
        ...
        frmtCPF.setBackground(new java.awt.Color(203, 39, 61));
        try {
            frmtCPF.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###.###.###-##")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        frmtCPF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                frmtCPFActionPerformed(evt);
            }
        });
        ...
        jButton3.setBounds(890, 500, 110, 29);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here: botao alterar
        
        Pacientes tstAlterado = new Pacientes(txtNome.getText(), frmtData.getText(), txtGender.getText(), 
        ...
        tstAlterado.atualizar(frmtCPF.getText());
    ...
    private void frmtCPFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_frmtCPFActionPerformed
        // TODO add your handling code here:
        
    }//GEN-LAST:event_frmtCPFActionPerformed

    private void txtPlanoSaudeFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPlanoSaudeFocusGained
        // TODO add your handling code here:
        
                        
        String text = txtPlanoSaude.getText();
        if (!text.equalsIgnoreCase("Amil") && !text.equalsIgnoreCase("Bradesco Saude") 
                && !text.equalsIgnoreCase("Unimed") && !text.equalsIgnoreCase("Prevent Senior")
                && !text.equalsIgnoreCase("SulAmerica") && !text.equalsIgnoreCase("NotreDame Intermedica")
                && !text.equalsIgnoreCase("Porto Seguro") && !text.equalsIgnoreCase("Golden Cross")
                && !text.equalsIgnoreCase("Alice")
                ) 
        
        {
            
            String[] options = {"Amil", "Bradesco Saude", "Unimed", "Prevent Senior", "SulAmerica", "NotreDame Intermedica",
                "Porto Seguro", "Golden Cross", "Alice"};
            
            
            String selectedOption = (String) 
                    JOptionPane.showInputDialog(controlePacientesAlterar.this, "Selecione um Plano:", 
                            "Plano Inválido", JOptionPane.QUESTION_MESSAGE, 
                            null, options, options[0]);
            
                    if (selectedOption != null) {
                        txtPlanoSaude.setText(selectedOption);
                    }
        }
        
        
    }//GEN-LAST:event_txtPlanoSaudeFocusGained

    private void txtGenderFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtGenderFocusGained
        // TODO add your handling code here:

        String text = txtGender.getText();
        if (!text.equalsIgnoreCase("Masculino") && !text.equalsIgnoreCase("Feminino")
            && !text.equalsIgnoreCase("Prefere Não Identificar" ))

        {

            String[] options = {"Masculino", "Feminino", "Prefere Não Identificar"};

            String selectedOption = (String)
            JOptionPane.showInputDialog(controlePacientesAlterar.this, "Selecione um Status:",
                "Status Inválido", JOptionPane.QUESTION_MESSAGE,
                null, options, options[0]);

            if (selectedOption != null) {
                txtGender.setText(selectedOption);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(controlePacientesAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new controlePacientesAlterar().setVisible(true);
            }
        });
    }
