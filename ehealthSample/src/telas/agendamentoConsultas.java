...
public class agendamentoConsultas extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        optionAgendamento inicial = new optionAgendamento();
        inicial.show();
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here: agendar
        
        Agendamento agndmnt = new Agendamento(txtNome.getText(), frmtNumero.getText(), 
                txtEspecialidade.getText(), txtMedico.getText(), frmtData.getText(), 
                frmtHora.getText(), txtType.getText(), txtUnidade.getText());
        agndmnt.inserir();
        
        optionAgendamento optn = new optionAgendamento();
        optn.show();
        this.dispose();
    ...
    private void txtTypeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTypeFocusLost
        ...
        if (!text.equalsIgnoreCase("Rotina") && !text.equalsIgnoreCase("Acompanhamento") 
            ...
            String selectedOption = (String) 
                    JOptionPane.showInputDialog(agendamentoConsultas.this, "Selecione um tipo:", 
                            "Tipo Inválido", JOptionPane.QUESTION_MESSAGE, 
                            null, options, options[0]);
            
                    if (selectedOption != null) {
                        txtType.setText(selectedOption);
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agendamentoConsultas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agendamentoConsultas().setVisible(true);
            }
        });
    }
