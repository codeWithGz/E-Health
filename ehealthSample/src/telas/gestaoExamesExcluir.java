...
public class gestaoExamesExcluir extends javax.swing.JFrame {

    /**
     * Creates new form gestaoExames
     */
    public gestaoExamesExcluir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        fileProntuario.setBounds(10, 10, 760, 510);
        ...
        jButton1.setBounds(883, 500, 120, 24);
        ...
        jButton5.setBounds(883, 500, 120, 24);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
                ...
                exam.excluir(txtExamPacient.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gestaoExamesExcluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gestaoExamesExcluir().setVisible(true);
            }
        });
    }
