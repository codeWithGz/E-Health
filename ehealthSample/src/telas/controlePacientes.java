...
public class controlePacientes extends javax.swing.JFrame {
    ...
    private void txtGenderFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtGenderFocusGained
        ...
        
        {
            ...
            String selectedOption = (String) 
                    JOptionPane.showInputDialog(controlePacientes.this, "Selecione um Status:", 
    ...
    private void txtPlanoSaudeFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPlanoSaudeFocusGained
...

        {
            ...
            String selectedOption = (String)
            JOptionPane.showInputDialog(controlePacientes.this, "Selecione um Plano:",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(controlePacientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new controlePacientes().setVisible(true);
            }
        });
    }
